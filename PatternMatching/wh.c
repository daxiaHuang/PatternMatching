...
*/
__inline cellValueT whPixel(Branch *branch, basisT basisInd, coordT y, coordT x) {
...
*/
__inline Matrix * whMatrix(Branch *branch, basisT basisInd) {
...
void whPatternMatch(WHSetup *setup, distanceT rejectThresh) {
	...
	cellValueT *patternProj  = setup->patternProjections;
